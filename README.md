# Production_bot
Демонстрационная версия телеграмм-бота для автоматизации бизнес-процессов производственной компании. Бот включает в себя веб-приложение и имеет следующие возможности:
